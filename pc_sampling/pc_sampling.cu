 ...
 * This app will work on device with compute capability 5.2
 */
#include <cuda.h>
#include <cupti.h>
#include <stdio.h>
...
main(int argc, char *argv[])
{
    ...
    if ((prop.major == 5) && (prop.minor == 2)) {
        ...
        printf("sample is waived on this device, pc sampling is supported on device with compute capability 5.2\n");
        return 0;
    }
